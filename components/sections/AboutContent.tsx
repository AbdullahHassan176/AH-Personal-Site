        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-5 text-[#5F5A55] text-[17px] leading-relaxed">
              <p>{profile.summary}</p>
              <p>
                My approach combines deep technical expertise with entrepreneurial vision, creating solutions
                that not only work today but are designed to scale and adapt to tomorrow&apos;s challenges.
                I believe in the power of AI to democratize access to advanced financial tools and create
                more efficient global trade systems.
              </p>
              <p>
                Beyond business, I&apos;m committed to sharing knowledge through speaking engagements,
                research publications, and mentoring the next generation of entrepreneurs. My goal is to
                build a future where technology serves humanity&apos;s greatest needs.
              </p>
            </div>
          </div>
